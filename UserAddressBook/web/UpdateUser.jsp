<%-- 
    Document   : UpdateUser
    Created on : 12 Aug, 2020, 6:13:20 PM
    Author     : juile
--%>
        ...
        %>
                ...
                <center>
                    <form action="UpdateUser" method="post">
                        ...
                        <hr style="border: none">
                        <label> Address: </label>
                        <input type="text" name="addr" value="<%= rs.getString("address")%>" required="true" />
                        <br>
                        <hr style="border: none">
                        <label> City: </label>
                        <input type="text" name="city" value="<%= rs.getString("city")%>" required="true" />
                        <br>
                        <hr style="border: none">
                        <label> State: </label>
                        <input type="text" name="state" value="<%= rs.getString("state")%>" required="true" />
                        <br>
                        <hr style="border: none">
                        <label> Zip Code: </label>
                        <input type="text" name="zip" value="<%= rs.getString("zip")%>" pattern="\d{6}" required="true" />
                        <br>
                        <hr style="border: none">
                        <label> Phone Number: </label>
                        <input type="text" name="phno" value="<%= rs.getString("phone_number")%>" pattern="^[6-9]{1}[0-9]{9}" required="true" />
                        <br>
                        <hr style="border: none">
